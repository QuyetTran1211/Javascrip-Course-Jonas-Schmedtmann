...
// const request = fetch('https://restcountries.com/v2/');
...
const getJSON = function (url, errorMsg = 'No neighbour country') {
...
//       renderCountry(data[0]);
//       const neighbour = data[0].borders[0];
//       if (!neighbour) throw new Error('No neighbour near this country!');
//       return getJSON(
...
that you received about the provided location. Then, using this data, log a message like this to the console: “You are in Berlin, Germany”
...
we have been using.
7. Render the country and catch any errors, just like we have done in the lastlecture (you can even copy this code, no need to type the same code) 
